...
// Official brand shapes from Simple Icons (https://simpleicons.org), rendered
// with currentColor so callers control the color.
const BRAND_PATHS: Record<Exclude<PlatformBrand, "other">, { d: string; label: string }> = {
  playstation: {
    label: "PlayStation",
...
/**
 * Brand icon for a game's platform (PlayStation / Xbox / Nintendo / Steam-PC).
 * Unrecognized platforms fall back to a generic gamepad. Renders with
 * currentColor — callers set size and color via className.
 */
export default function PlatformIcon({
  ...
  const { d, label } = BRAND_PATHS[brand];
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
